...
const HomePageContentComponent: React.FC<HomePageContentComponentProps> = ({
  recapData,
}) => {
                ...
                >
                  <div className="elementor-widget-container">
                    <LatestPostDecouverteHome
                      articlesdecouvertes={articles["decouvertes"] || []}
                    />
                    <br />
                    <br />
                    {/*<LatestPostEventHome/>*/}
                    <LatestPostEventHome
                      articlesevent={articles["events"] || []}
                    />
                    <br />
                    <br />
                    <LatestPostPortraitHome
                      articlesportrait={articles["mode-beaute"] || []}
                    />
                    <br />
                    <br />
                    <LatestPostBonPlanHome
                      articlesbonplan={articles["musique"] || []}
                    />
                  </div>
                </div>
              </div>
                ...
                >
                  <div className="elementor-widget-container">
                    <LatestPostTopStarHome
                      articlestopstar={articles["decouvertes-bons-plans"] || []}
                    />
                  </div>
                </div>
                ...
                >
                  <div className="elementor-widget-container">
                    <LatestPostSocieteHome
                      articlesociete={articles["people"] || []}
                    />
                  </div>
                </div>
                <div
                  ...
                  <div className="elementor-widget-container">
                    ...
                    >
                      <LatestPostGalerieHome
                        articlegalery={articles["photos-galeries-photos"] || []}
                      />
                      <LatestPostVideoHome
                        articlevideo={articles["videos"] || []}
                      />
                    </section>
                  </div>
                </div>
            ...
            >
              <div className="elementor-widget-wrap elementor-element-populated">
                ...
                >
                  <div className="elementor-widget-container">
                    <SidebarDeuxHome
                      articlesidebardeuxhome={mostviewed || []}
                    />
                  </div>
                </div>
                <NewsleterComponent />
